...
const{ getCandidates,getEmployerProfile, select_candidate, reject_candidate, get_jobs, get_company, get_applied_candidates, get_selected_candidates, createNewJob } = require("../Controllers/employerController")
