...
const{ getCandidates,getEmployerProfile, select_candidate, reject_candidate, get_jobs, get_company, get_applied_candidates, get_selected_candidates, get_company_fromid } = require("../Controllers/employerController")
